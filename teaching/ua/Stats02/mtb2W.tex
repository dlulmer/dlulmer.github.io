...
\begin{document}
\title{Math 160/263 Minitab Assignment \# 2 - Windows Version} 
...
\item  The average annual incomes in 1999 of workers in the fifty states
and the District of Columbia are given in data2.MTW.

\begin{enumerate}

\item  Use the {\bf Graph} menu command to make a stemplot of the data.  

\item  Use the {\bf Stat \boldmath $>$ \unboldmath Basic Statistics 
\boldmath $>$ \unboldmath Display Descriptive 
Statistics} menu command to find the mean and median of the distribution.
...
\item  Use the {\bf Graph} menu command to make a histogram of the data.

\item  Briefly describe the shape of the distribution.

\item  Use the {\bf Graph} menu command to make a time series plot of the 
data.
