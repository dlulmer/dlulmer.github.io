...
\begin{document}
\title{Math 160/263 Minitab Assignment \# 11 - Unix Version} 
...
\item  Carry out a {\bf TTESt}.  Can you reject $H_o$ at the 5\% 
significance level?  At the 1\% significance level?

\item  Give a 90\% {\bf TINTerval} for the mean monthly cost for 
all Internet users.
...
\item  Carry out the test using the {\bf TWOSample t} command.  Is the
