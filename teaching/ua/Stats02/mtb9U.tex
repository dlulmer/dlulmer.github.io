...
\begin{document}
\title{Math 160/263 Minitab Assignment \# 9 - Unix Version} 
...
\item  Use the {\bf ZINTerval} command to find 90\%, 95\%, and 
95\% confidence intervals for the true concentration of the active 
ingredient.
...
\item  Use the {\bf ZINTerval} command to find a 95\% confidence 
interval for the mean DMS odor threshold among all beginning oenology 
students.
...
\item  Use the {\bf ZINTerval} command to compute a 90\% confidence 
interval from each of your columns.

\item  How many of your confidence intervals actually contain the true 
mean?
