...
\begin{document}
\title{Math 160/263 Minitab Assignment \# 4 - Unix Version} 
...
\item  Use the {\bf SAMPle} command to select an SRS of size 119 from 
from the 1190 tenured professors.

\item  Use the {\bf TALLy} command to summarize the results.

\item  How many of the professors in the sample are aged 50 to 59?
How many of the professors in the sample are aged70 or older?
