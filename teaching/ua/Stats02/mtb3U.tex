...
\begin{document}
\title{Math 160/263 Minitab Assignment \# 3 - Unix Version} 
...
\item  Make an {\bf LPLOt} of highway mileage against ciy 
mileage, using different symbols for the the midsize cars and SUVs.
...
\item  Find the {\bf CORRelation} between city mileage and highway 
...
\item  We would like to predict steps per second from running speed.  Make
a {\bf PLOT} of the data with this goal in mind.

\item  Briefly describe the direction, form and strength of the 
relationship between speed and steps per second.

\item  Find the least-squares {\bf REGRession} line of steps per second on
